...
[CreateAssetMenu(menuName = "Data/StateMachine/PlayerState/JumpUpRun", fileName = "JumpUpRun")]
public class JumpUpRun : PlayerState
{
    /*
    ...
    */
    ...
    {   
        playerController.Move(playerData.runSkySpeed);
    }
